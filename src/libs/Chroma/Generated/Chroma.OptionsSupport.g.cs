...
namespace Chroma
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Chroma.AutoSDKRetryOptions Retry { get; set; } = new global::Chroma.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Chroma.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Chroma.IAutoSDKHook>();
        ...
        public global::Chroma.AutoSDKClientOptions AddHook(
            global::Chroma.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Chroma.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Chroma.AutoSDKClientOptions UseAuthorizationProvider(
            global::Chroma.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Chroma.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Chroma.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Chroma.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Chroma.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Chroma.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Chroma.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Chroma.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Chroma.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Chroma.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Chroma.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Chroma.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Chroma.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Chroma.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Chroma.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Chroma.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Chroma.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Chroma.AutoSDKClientOptions clientOptions,
            global::Chroma.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Chroma.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Chroma.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Chroma.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Chroma.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Chroma.IAutoSDKHook, global::Chroma.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Chroma.AutoSDKHookContext context)
        {
