...
namespace Chroma
{
    public partial class CollectionClient
    {
        ...
        private static readonly global::Chroma.EndPointSecurityRequirement s_GetCollectionByIdSecurityRequirement0 =
        ...
        private static readonly global::Chroma.EndPointSecurityRequirement[] s_GetCollectionByIdSecurityRequirements =
            new global::Chroma.EndPointSecurityRequirement[]
            {                s_GetCollectionByIdSecurityRequirement0,
            };
        partial void PrepareGetCollectionByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string tenant,
            ref string database,
            ref string collectionId);
        partial void PrepareGetCollectionByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string tenant,
            string database,
            string collectionId);
        partial void ProcessGetCollectionByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetCollectionByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Chroma.Collection> GetCollectionByIdAsync(
            string tenant,
            string database,
            string collectionId,
        ...
        {
            var __response = await GetCollectionByIdAsResponseAsync(
                tenant: tenant,
                database: database,
        ...
        /// const collection = await client.getCollectionById({ id: 'collection-uuid-here' });
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Chroma.AutoSDKHttpResponse<global::Chroma.Collection>> GetCollectionByIdAsResponseAsync(
            string tenant,
            string database,
            string collectionId,
            global::Chroma.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetCollectionByIdArguments(
            ...
            var __authorizations = global::Chroma.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetCollectionByIdSecurityRequirements,
                operationName: "GetCollectionByIdAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Chroma.PathBuilder(
                                path: $"/api/v2/tenants/{tenant}/databases/{database}/collections/by-id/{collectionId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetCollectionByIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Chroma.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Chroma.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetCollectionByIdAsync",
                                pathTemplate: "$\"/api/v2/tenants/{tenant}/databases/{database}/collections/by-id/{collectionId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetCollectionByIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Chroma.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetCollectionByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Chroma.Collection.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Chroma.AutoSDKHttpResponse<global::Chroma.Collection>(
                                        statusCode: __response.StatusCode,
                                ...
                                {
                                    throw global::Chroma.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Chroma.Collection.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
