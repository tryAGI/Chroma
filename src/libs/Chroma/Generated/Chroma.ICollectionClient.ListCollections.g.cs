...
namespace Chroma
{
    public partial interface ICollectionClient
    {
        ...
        /// const collections = await client.listCollections({ limit: 10, offset: 0 });
        /// </remarks>
        global::System.Threading.Tasks.Task<global::Chroma.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Chroma.VecItem>>> ListCollectionsAsResponseAsync(
            string tenant,
            string database,
            int? limit = default,
            int? offset = default,
