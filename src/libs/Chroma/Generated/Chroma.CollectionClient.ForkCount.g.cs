...
namespace Chroma
{
    public partial class CollectionClient
    {
        ...
        private static readonly global::Chroma.EndPointSecurityRequirement s_ForkCountSecurityRequirement0 =
        ...
        private static readonly global::Chroma.EndPointSecurityRequirement[] s_ForkCountSecurityRequirements =
            new global::Chroma.EndPointSecurityRequirement[]
            {                s_ForkCountSecurityRequirement0,
            };
        partial void PrepareForkCountArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string tenant,
            ref string database,
            ref string collectionId);
        partial void PrepareForkCountRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string tenant,
            string database,
            string collectionId);
        partial void ProcessForkCountResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessForkCountResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Chroma.ForkCountResponse> ForkCountAsync(
            string tenant,
            string database,
            string collectionId,
        ...
        {
            var __response = await ForkCountAsResponseAsync(
                tenant: tenant,
                database: database,
        ...
        /// const count = await collection.forkCount();
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Chroma.AutoSDKHttpResponse<global::Chroma.ForkCountResponse>> ForkCountAsResponseAsync(
            string tenant,
            string database,
            string collectionId,
            global::Chroma.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Chroma.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ForkCountSecurityRequirements,
                operationName: "ForkCountAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Chroma.PathBuilder(
                                path: $"/api/v2/tenants/{tenant}/databases/{database}/collections/{collectionId}/fork_count",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Chroma.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Chroma.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ForkCount",
                                methodName: "ForkCountAsync",
                ...
                else
                {
                    await global::Chroma.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessForkCountResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Chroma.ForkCountResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Chroma.AutoSDKHttpResponse<global::Chroma.ForkCountResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Chroma.ForkCountResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
