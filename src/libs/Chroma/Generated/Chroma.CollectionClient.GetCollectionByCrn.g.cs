...
namespace Chroma
{
    ...
    {
        partial void PrepareGetCollectionByCrnArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string crn);
        partial void PrepareGetCollectionByCrnRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string crn);
        partial void ProcessGetCollectionByCrnResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetCollectionByCrnResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Chroma.Collection> GetCollectionByCrnAsync(
            string crn,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetCollectionByCrnArguments(
            ...
            PrepareGetCollectionByCrnRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetCollectionByCrnResponse(
                httpClient: HttpClient,
            ...
            if ((int)__response.StatusCode == 401)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        __value_401 = await global::Chroma.ErrorResponse.FromJsonStreamAsync(__contentStream_401, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
            ...
            if ((int)__response.StatusCode == 404)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        __value_404 = await global::Chroma.ErrorResponse.FromJsonStreamAsync(__contentStream_404, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                catch (global::System.Exception __ex)
                {
            ...
            if ((int)__response.StatusCode == 500)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        __value_500 = await global::Chroma.ErrorResponse.FromJsonStreamAsync(__contentStream_500, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                catch (global::System.Exception __ex)
                {
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetCollectionByCrnResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
