...
namespace Chroma
{
    public partial interface IRecordClient
    {
        ...
        /// </remarks>
        global::System.Threading.Tasks.Task<global::Chroma.AddCollectionRecordsResponse> CollectionAddAsync(
            string tenant,
            string database,
            string collectionId,
        ...
        /// await collection.add({ ids: ['id1', 'id2'], embeddings: [[0.1, 0.2], [0.3, 0.4]], documents: ['doc1', 'doc2'] });
        /// </remarks>
        global::System.Threading.Tasks.Task<global::Chroma.AutoSDKHttpResponse<global::Chroma.AddCollectionRecordsResponse>> CollectionAddAsResponseAsync(
            string tenant,
            string database,
            string collectionId,
