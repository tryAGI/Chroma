...
namespace Chroma
{
    ...
    public sealed partial class SpannIndexConfig
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Chroma.JsonConverters.QuantizationJsonConverter))]
        public global::Chroma.Quantization? Quantize { get; set; }
        ...
        public SpannIndexConfig(
            ...
            global::Chroma.Quantization? quantize,
